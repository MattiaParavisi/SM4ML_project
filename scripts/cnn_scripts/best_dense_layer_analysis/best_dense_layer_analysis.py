...
plt.show()
plt.savefig('best_dense_layer_analysis_accuracy.png')
plt.clf()
...
plt.show()
plt.savefig('best_dense_layer_analysis_val_accuracy.png')
plt.clf()
...
plt.show()
plt.savefig('best_dense_layer_analysis_loss.png')
plt.clf()
...
plt.show()
plt.savefig('best_dense_layer_analysis_val_loss.png')
plt.clf()
