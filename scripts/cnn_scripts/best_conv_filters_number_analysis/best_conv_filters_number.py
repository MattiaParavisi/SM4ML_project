...
plt.show()
plt.savefig('best_conv_filters_numb_analysis_accuracy.png')
plt.clf()
...
plt.show()
plt.savefig('best_conv_filters_numb_analysis_val_accuracy.png')
plt.clf()
...
plt.show()
plt.savefig('best_conv_filters_numb_analysis_loss.png')
plt.clf()
...
plt.show()
plt.savefig('best_conv_filters_numb_analysis_val_loss.png')
plt.clf()
